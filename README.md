...
**[11](https://github.com/fnando-gomez/Codewars-Euler-project-Code-challenges-Technical-Interviews/blob/master/zipdev/zipdev1.js) Reverse words** | Technical exercise | Your task is to reverse the order or words in each line of input, while preserving the words themselves.

**12 Chain of words** | Technical exercise | Your task is to identify the length of the chain of words. 
